...
gcloud run deploy $SERVICE `
    ...
    --timeout 300 `
    --concurrency 80 `
    --set-env-vars "GOOGLE_GENAI_USE_VERTEXAI=false,USE_SQLITE=true,ENV=production,GOOGLE_TOKEN_FILE=$TOKEN_MOUNT_PATH,GOOGLE_CREDENTIALS_FILE=$CLIENT_SECRET_MOUNT_PATH" `
